...
def post_generic_sample_data(app_config, db_table, sample_data_in: Dict[str,Any]):
    expected_keys = ["SampleId", "ProductId", "MeasurementId", "ParentId", "SubsampleId", "DataType", "Data"]
